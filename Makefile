...
# The portal/frantic theme is no longer a standalone module: build_songs.py bakes
...
# music_layout.h is generated by `make songs` (committed source); recompile audio
# when it changes so the calm/frantic order positions stay in sync.
src/audio.obj: include/soundbank_banks.h include/music_layout.h
